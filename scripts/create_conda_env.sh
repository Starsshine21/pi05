...
RLINF_ROOT="${RLINF_ROOT:-$REPO_ROOT/local_vendor/RLinf-main}"
RLINF_VENV_SITE_PACKAGES="${RLINF_VENV_SITE_PACKAGES:-$REPO_ROOT/recap_workspace/.venv_recap311/lib/python3.11/site-packages}"
